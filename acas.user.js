...
const repositoryRawURL = 'https://raw.githubusercontent.com/Whobler/A.C.A.S-V.2';
const repositoryURL = 'https://github.com/Whobler/A.C.A.S-V.2';
...
Gui.settings.window.title = 'A.C.A.S. v2';
...
function addGuiPages() {
        ...
        <div class="card">
            <div class="card-body">
                <div class="main-title-bar">
                    <h5 class="card-title">Realtime Chessboard</h5>
    ...
    <div class="rendered-form">
        <div class="card">
            <div class="card-body">
                <p class="lead">
                  <b>A.C.A.S V.2</b> <i>(Advanced Chess Assistance System V.2)</i> is an advanced chess assistance system which enhances your chess performance with real-time move analysis.
                </p>
            </div>
            <div class="card-footer sideways-card">Developers <small>Whobler</small></div>
            <div class="card-footer sideways-card">Version <small>${GM_info.script.version}</small></div>
            <div class="card-footer sideways-card">Repository <a href="${repositoryURL}" target="_blank">A.C.A.S V.2</a></div>
        </div>
    </div>
    `);
}
...
if(typeof GM_registerMenuCommand == 'function') {
    GM_registerMenuCommand("Open A.C.A.S V.2", e => {
        if(chessBoardElem) {
            initialize(true);
        }
    }, 's');
